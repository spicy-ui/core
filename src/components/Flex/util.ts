...
export interface FlexComponentProps<ThemeType extends Theme = RequiredTheme> {
  /**
...
export const flexComponent = system(config);

export const flexComponentProps = ['align', 'justify', 'wrap', 'direction'];
