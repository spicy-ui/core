...
export const Button: ComponentThemeConfig<ButtonProps> = {
  ...
  baseStyle: ({ isFullWidth }) => ({
    ...
    lineHeight: '1.2',
    outline: 'none',
    transitionProperty: ({ transition }: any) => transition.property.common,
    transitionTimingFunction: ({ transition }: any) => transition.timingFn.inOut,
    transitionDuration: ({ transition }: any) => transition.duration[300],
    userSelect: 'none',
